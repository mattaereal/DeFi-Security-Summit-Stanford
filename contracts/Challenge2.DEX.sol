...
contract InsecureDexLP {
    ...
    function addLiquidity(uint256 amount0, uint256 amount1) external {
        ...
        // @dev If liquidity exists, update shares with supplied amounts
            ...
            liquidity = Math.min((amount0 * _totalLiquidity) / reserve0, (amount1 *_totalLiquidity) / reserve1);
        }
    ...
    // OK -- 
    // Primero calcula cuánto corresponde el cambio, y luego, transfiere a sí mismo
    // los tokens envíados, y saca de sí mismo los tokens que tiene que enviar.
    // Aquí tampoco chequea las reservas primero, va a gastar gas al pp.
